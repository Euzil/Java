...
public class EnctryAndUnEntryFrame extends JFrame {
    ...
    protected void do_confirmButton_actionPerformed(ActionEvent arg0) {
        ...
        JOptionPane.showMessageDialog(getContentPane(), "文件加密成功！", "信息提示框", JOptionPane.WARNING_MESSAGE); // 为用户提供提示信息对话框
    }
    ...
    protected void undo_confirmButton_actionPerformed(ActionEvent arg0) {
        ...
        encryFile.unEncry(unentryTextField.getText(), unsaveTextField.getText());
        JOptionPane.showMessageDialog(getContentPane(), "文件解密成功！", "信息提示框", JOptionPane.WARNING_MESSAGE); // 为用户提供提示信息对话框
    }
