...
public class Money { // 创建一个Money类
	public static void main(String[] args) {
		...
		list.add(new Account("2018-05-06", 2000, 0));
		list.add(new Account("2018-05-18", 0, 1000));
		list.add(new Account("2018-06-08", 5000, 0));
		list.add(new Account("2018-06-23", 0, 1500));
		list.add(new Account("2018-07-03", 3000, 0));
		list.add(new Account("2018-07-19", 0, 1000));
		list.add(new Account("2018-08-01", 1000, 0));
		list.add(new Account("2018-08-10", 0, 1500));
