...
public class NodeState extends JFrame {
    ...
    protected void do_this_windowActivated(WindowEvent e) {
        ...
        parent1.add(new DefaultMutableTreeNode("《Java从入门到精通（第5版）》"));
        parent1.add(new DefaultMutableTreeNode("《PHP从入门到精通（第5版）》"));
        parent1.add(new DefaultMutableTreeNode("《Visual Basic从入门到精通（第5版）》"));
        parent1.add(new DefaultMutableTreeNode("《Visual C++从入门到精通（第5版）》"));
        root.add(parent1);
