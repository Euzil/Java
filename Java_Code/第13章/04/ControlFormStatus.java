...
public class ControlFormStatus extends JFrame {
    ...
    public ControlFormStatus() {
        ...
        button_1.setSelectedIcon(new ImageIcon(ControlFormStatus.class.getResource("maxBH.jpg")));
        button_1.setIcon(new ImageIcon(ControlFormStatus.class.getResource("maxB.jpg")));
        ...
        button_2.setRolloverIcon(new ImageIcon(ControlFormStatus.class.getResource("closeBH.jpg")));
        button_2.setFocusPainted(false);
        button_2.setContentAreaFilled(false);
        button_2.setBorderPainted(false);
        button_2.setIcon(new ImageIcon(ControlFormStatus.class.getResource("closeB.jpg")));
        panel.add(button_2);
